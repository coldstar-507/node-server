...
func TestMain(m *testing.M) {
	...
	dist := bsv.GeoDist(
		&flatgen.LatLonT{Lat: 46.31585857259396, Lon: -72.5494256605008},
		&flatgen.LatLonT{Lat: 46.77383958951538, Lon: -71.09242612644653},
	)
	dist2 := bsv.GeoDist(
		&flatgen.LatLonT{Lat: 46.94589131490488, Lon: -71.2888815994351},
		&flatgen.LatLonT{Lat: 46.807092314421034, Lon: -71.22967468461174},
	)
...
func TestLayerQuebecCity(t *testing.T) {
	a := &flatgen.AreaT{
		Center: &flatgen.LatLonT{Lat: 46.82749877182937, Lon: -71.22776575143017},
		Perim: []*flatgen.LatLonT{
...
func TestLayerQuebecCities(t *testing.T) {
	a := &flatgen.AreaT{
		Center: &flatgen.LatLonT{Lat: 46.36683529877258, Lon: -72.58105744075569},
		Perim: []*flatgen.LatLonT{
